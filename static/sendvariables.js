    ...
    if ($("#wikiframe").length == 0) {
        ...
        if ((s != "") && (s != null)) {
			...
			<div id='wikiframe'>\
                ...
                <iframe src='http://publicradioroadtrip.appspot.com/publicradioroadtrip/default/add_story?nprid=" + s + '&title=' + story_title + "' onload=\"$('#wikiframe iframe').slideDown(500);\">Enable iFrames.</iframe>\
				<style type='text/css'>\

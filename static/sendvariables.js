    ...
    if ($("#wikiframe").length == 0) {
        ...
        if ((s != "") && (s != null)) {
			...
			<div id='wikiframe'>\
                ...
                <iframe src='http://localhost:8000/publicradioroadtrip/default/add_story?storyID=" + s + '&title=' + story_title + "' onload=\"$('#wikiframe iframe').slideDown(500);\">Enable iFrames.</iframe>\
				<style type='text/css'>\
